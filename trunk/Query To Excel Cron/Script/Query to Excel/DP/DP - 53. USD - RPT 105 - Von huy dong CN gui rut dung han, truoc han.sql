--define h_trdt ='20120913' --20120911

select detail.BRCD, detail.CUSTSEQ, detail.NM, detail.IDXACNO,	detail.GUI, detail.RUT,	 detail.CHENHLECH,	 detail.HBRCD, detail.HUSRID,	detail.DEPTNMLOC, detail.REM,	 detail.OPNDT, detail.LOCDPNM,	detail.LS, com.chenhlech_th,
		matdt, loai,
		clsdt, opndt,
