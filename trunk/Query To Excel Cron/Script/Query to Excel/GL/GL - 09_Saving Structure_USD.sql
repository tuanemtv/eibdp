				...
				FROM
					(
						SELECT  G.BRCD BRCD, G.ACCTCD ACCTCD,
				   			SUM(G.TDBAL) TDBAL1,  0 TDBAL2, 0 TDBAL3, 0 TDBAL4,0 TDBAL5
						FROM
							(
						...
						UNION ALL
						SELECT  G.BRCD BRCD, G.ACCTCD ACCTCD, 0 TDBAL1,	sum(G.TDBAL) TDBAL2, 0 TDBAL3, 0 TDBAL4,0 TDBAL5
						FROM
							(
								SELECT  A.TRDT,  A.BRCD BRCD, A.CCY CCY,  A.ACCTCD ACCTCD, SUM(A.TDBAL + A.TDACRBAL) TDBAL
								FROM 	 GL1.TBGL_MAST A
						...
						GROUP BY  G.TRDT, G.BRCD, G.ACCTCD
						UNION ALL
						SELECT  G.BRCD BRCD, G.ACCTCD ACCTCD, 0 TDBAL1, 0 TDBAL2, sum(G.TDBAL) TDBAL3,0 TDBAL4,0 TDBAL5
						FROM
							(
								SELECT  A.TRDT,  A.BRCD BRCD, A.CCY CCY,  A.ACCTCD ACCTCD, SUM(A.TDBAL + A.TDACRBAL) TDBAL
								FROM 	 GL1.TBGL_MAST A
						...
						GROUP BY  G.TRDT, G.BRCD, G.ACCTCD
						UNION ALL
						SELECT  G.BRCD BRCD, G.ACCTCD ACCTCD, 0 TDBAL1, 0 TDBAL2, 0 TDBAL3,sum(G.TDBAL) TDBAL4,0 TDBAL5
						FROM
							(
								SELECT  A.TRDT,  A.BRCD BRCD, A.CCY CCY,  A.ACCTCD ACCTCD, SUM(A.TDBAL + A.TDACRBAL) TDBAL
								FROM 	 GL1.TBGL_MAST A
						...
						GROUP BY  G.TRDT, G.BRCD, G.ACCTCD
						UNION ALL
						SELECT  G.BRCD BRCD, G.ACCTCD ACCTCD, 0 TDBAL1, 0 TDBAL2, 0 TDBAL3,0 TDBAL4,SUM(G.TDBAL) TDBAL5
						FROM
							(
								SELECT  A.TRDT,  A.BRCD BRCD, A.CCY CCY,  A.ACCTCD ACCTCD, SUM(A.TDBAL + A.TDACRBAL) TDBAL
								FROM 	 GL1.TBGL_MAST A
