...
public class CommandMultiQuery2{
	
	Connection _conn;
	Query _query;  
	AppCommon _app;
	private static Logger logger =Logger.getLogger("CommandMultiQuery2");
	...
	public CommandMultiQuery2(Connection _conn, Query _query, AppCommon _app) {
		
		super();
		this._conn = _conn;
		this._query = _query;
		this._app = _app;
		logger.info("Vao day ko");
	}
