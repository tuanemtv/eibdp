select a.TRDT NGAY, c.LCLBRNM CN, a.CCY LTIEN, sum(a.ACRBAMT) SODU, a.BSRT LS_KHACHHANG, a.INTRT GIAFTP_QUAHAN, TO_char(to_date(a.OPNDT,'YYYYMMDD'),'dd MON, yyyy') NGAYGIAINGAN, TO_char(to_date(a.MATDT,'YYYYMMDD'),'dd MON, yyyy') NGAYDAOHAN, '0M' CKYDOILS
from
(
